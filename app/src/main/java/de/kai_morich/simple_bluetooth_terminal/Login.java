...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String CREATE_reg_TABLE = "CREATE TABLE IF NOT EXISTS user('userid' TEXT,'pwd' TEXT,'username' TEXT,'address' TEXT,'phone' TEXT,'email' TEXT)";
        con.execSQL(CREATE_reg_TABLE);

        String CREATE_loggedin_TABLE = "CREATE TABLE IF NOT EXISTS loggedin('userid' TEXT,'pwd' TEXT,'username' TEXT,'address' TEXT,'phone' TEXT,'email' TEXT)";
        ...
        b3.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View arg)
            {
                ...
                if(c.getCount()>0)
                {
                    con.execSQL("INSERT INTO loggedin (userid,pwd) Values ('"+ e1.getText().toString() +"','"+ e2.getText().toString() +"');");
